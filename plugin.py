...
class Plugin(object):
    ...
    def get_mqtt_client(self, app_id):
        ...
        # TODO: need to externalze this
        # mqtt_client.username_pw_set(args.get('mqtt-user'), args.get('mqtt-pass'))
        mqtt_client.username_pw_set('sysadmin', 'sysadmin')
        mqtt_client.connect('pi02', port=1883)
